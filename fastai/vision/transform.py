...
__all__ = ['brightness', 'contrast', 'crop', 'crop_pad', 'cutout', 'dihedral', 'dihedral_affine', 'flip_affine', 'flip_lr',
           ...
           'rand_resize_crop', 'symmetric_warp', 'tilt', 'zoom', 'zoom_crop', 'grayscale']
...
def _crop_pad(x, size=64, padding_mode='reflection', row_pct:uniform = 0.5, col_pct:uniform = 0.5):
...
def get_transforms(do_flip:bool=True, flip_vert:bool=False, use_grayscale:bool=False, max_rotate:float=10., max_zoom:float=1.1,
    ...
    res = []
    if use_grayscale: res.append(grayscale())
